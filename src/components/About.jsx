        ...
        <>
            <main className="about-wrapper" id="about">
                ...
                <div className="about-description">
                    <p>My name is Suman Roy. I am currently pursuing my bachelors in computer science. I have keen interest and a passion for the web, so I started learning web development few months ago. With time I kept on honing my skills, moved onto frameworks and other tools. </p>
